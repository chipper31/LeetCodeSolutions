class Solution:
    def minimumPushes(self, word: str) -> int:
        # note: i didnt know all letters would be distinct until
        # after i had implemented the letter frequency stuff but
        # i dont feel like removing the letter frequency stuff
        letterFrequencies={}
        letterFreqList = []
        totalKeyPresses = 0
...
print(Solution.minimumPushes(Solution, "xycdefghij"))